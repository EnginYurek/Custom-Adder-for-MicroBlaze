...
int main()
{
    ...
    SERIAL_ADDER_8_BIT_mWriteSlaveReg0(XPAR_SERIAL_ADDER_8_BIT_0_BASEADDR, 0, 7);
    SERIAL_ADDER_8_BIT_mWriteSlaveReg1(XPAR_SERIAL_ADDER_8_BIT_0_BASEADDR, 0, 12);
    SERIAL_ADDER_8_BIT_mWriteSlaveReg2(XPAR_SERIAL_ADDER_8_BIT_0_BASEADDR, 0, 1);
...
void DeviceDriverHandler(void *CallbackRef)
{
	...
	u32 data = SERIAL_ADDER_8_BIT_mReadSlaveReg3(XPAR_SERIAL_ADDER_8_BIT_0_BASEADDR, 0);
